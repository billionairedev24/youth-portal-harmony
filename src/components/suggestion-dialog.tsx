            ...
            {mode === "review" && suggestion.status === "new" && (
              <div>
                ...
                <Textarea
                  ...
                  className="min-h-[100px] resize-none bg-gold-50/50 border-gold-200 focus:border-gold-300 focus:ring-0 focus:outline-none focus-visible:ring-0 focus-visible:ring-offset-0 placeholder:text-gold-500/70"
                />
              </div>
            )}
          </div>
